...
public class registerdb extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ResultSet rs;
			String sql = "insert into registration(name,nic,gender,address,mem_type,blood_group,status,dob,email,mobile,password ) values ('"
					+ name + "','" + nic + "','" + gender + "','" + address + "','" + mem_type + "','" + blood_group
					+ "','" + status + "','" + dob + "','" + email + "','" + mobile + "','" + password + "')";
