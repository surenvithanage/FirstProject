...
public class PatientFormCheck extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String sql = "insert into patienthistory(firstname,lastname,gender,age,bloodtype,allergies,treatmentdetails,surgerydetails) values ('"
					+ firstname + "','" + lastname + "','" + gender + "','" + age + "','" + bloodtype + "','"
					+ allergies + "','" + treatmentdetails + "','" + surgerydetails + "')";
