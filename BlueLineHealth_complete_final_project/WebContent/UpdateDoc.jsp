...
<style>
input[type=text], input[type=textarea], input[type=password], input[type=email],
	select[type=text] {
	width: 296px;
	padding: 12px 20px;
	margin: 8px 0;
	...
	<div class="content">
		...
		<form style="align: 'right'" method="post" action="UpdateDocDetails">
			<table>
				...
				<tr>
					<td></td>
					<td><input type="checkbox" name="checkpwd"
						onclick="pwdFuntion()">Show password</td>
				</tr>
				<tr>
					<td><h4>&nbsp;&nbsp;MC Registration Number:</h4></td>
					<td><input type="text" id="mcRegistrationNumber"
						name="mcRegistrationNumber"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" id="specialization"
						name="specialization"></td>
				</tr>
				<tr>
					<td><h4>&nbsp;&nbsp;Working experience:</h4></td>
					<td><input type="text" id="workingExperience"
			...
			<button class="button back"
				onclick="location.href = 'DoctorManagement.jsp';">Back</button>
		</form>
		<!--End form-->
		<!--Table doc details-->
